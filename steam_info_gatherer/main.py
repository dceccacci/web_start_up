...
def main():
    ...
    # Limit to the first 10 app IDs
    print_log('Requested to narrow down results to {total_limit} app ids')
    all_app_ids = all_app_ids[lower_limit:upper_limit]
    len_all_app_ids = len(all_app_ids)
    print_log('Actually narrowed down to {len_all_app_ids}')
